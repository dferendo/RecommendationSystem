...
class Discriminator(nn.Module):
    def __init__(self, dim, sequence_len, number_of_movies):
        ...
        self.conv1d = nn.Conv1d(number_of_movies, self.dim, 1)
        self.linear = nn.Linear(self.sequence_len * self.dim, 1)
